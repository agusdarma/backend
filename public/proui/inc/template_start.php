...
<!--[if gt IE 9]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
    <head>
        ...
        <!-- Include a specific file here from proui/css/themes/ folder to alter the default theme of the template -->
        <?php if ($template['theme']) { ?><link id="theme-link" rel="stylesheet" href="proui/css/themes/<?php echo $template['theme']; ?>.css"><?php } ?>
